...
public class TCPIP {
    ...
    public static TCPIP createServerSocket() {
        try {
            ...
            System.out.println("Servidor> Recibida conexión de " + socket.getInetAddress().getHostAddress() + ":" + socket.getPort());
    ...
    public String receiveLine() {
        ...
        try {
            ...
            System.out.println("Error en el servidor!!! Lectura de string");
        }
        return result;
    }
