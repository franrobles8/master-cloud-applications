...
public class DraughtTest {
    ...
    private void setGame(Color color, Map<Integer,String> rows) {
        GameBuilder gameBuilder = new GameBuilder().color(color);
        for (Entry<Integer,String> row : rows.entrySet())
            gameBuilder.row(row.getKey(),row.getValue());
        this.game = gameBuilder.build();
    }

    private void setExpectedGame(Color color, Map<Integer,String> rows) {
        GameBuilder gameBuilder = new GameBuilder().color(color);
        for (Entry<Integer,String> row : rows.entrySet())
            gameBuilder.row(row.getKey(),row.getValue());
        this.expectedGame = gameBuilder.build();
    }

    private Map<Integer,String> getDraughtGame(List<Entry<Integer,String>> rows) {
        return rows.stream()
    ...
    @Test
    public void moveWithBlackCorrectMovement() {
    ...
    @Test
    public void moveWithWhiteCorrectMovement() {
